...
@interface VentureDatabase()
@property (nonatomic, readwrite, strong) NSManagedObjectContext *managedObjectContext;
@end

@implementation VentureDatabase

+ (VentureDatabase *)sharedDefaultVentureDatabase {
    return [self sharedVentureDatabaseWithName:@"VentureDatabase_DEFAULT"];
}

+ (VentureDatabase *)sharedVentureDatabaseWithName:(NSString *)name {
    static NSMutableDictionary *databases = nil;
    if (!databases) databases = [[NSMutableDictionary alloc] init];
    
    VentureDatabase *database = nil;
...
- (void)setManagedObjectContext:(NSManagedObjectContext *)managedObjectContext {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:VentureDatabaseAvailable object:self];
}
